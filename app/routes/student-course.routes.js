module.exports = app => {
    ...
    app.get("/student-courses/get-score/:courseId/:studentId", studentcourse.getStudentPoints);

    app.get("/student-courses/get-all-mod-score/:courseId", studentcourse.getAllPossiblePoints);
};